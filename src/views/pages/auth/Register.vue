    ...
    <div class="px-5 min-h-screen flex justify-content-center align-items-center">
        <div class="border-1 surface-border surface-card border-round py-7 px-4 md:px-7 z-1">
            <div class="mb-4">
                ...
                <span class="text-600 font-medium">Valido para proveedores y vendedores</span>
            </div>
            <div class="flex flex-column">
                <span class="p-input-icon-left w-full mb-4">
                    <i class="pi pi-user"></i>
                    <InputText id="username" type="text" class="w-full md:w-25rem" placeholder="Nombre de empresa" />
                </span>
                <span class="p-input-icon-left w-full mb-4">
                    <i class="pi pi-envelope"></i>
                    <InputText id="email" type="text" class="w-full md:w-25rem" placeholder="Razon social" />
                </span>
                <span class="p-input-icon-left w-full mb-4">
                    <i class="pi pi-user"></i>
                    <InputText id="username" type="text" class="w-full md:w-25rem" placeholder="Nombre contacto" />
                </span>
                <span class="p-input-icon-left w-full mb-4">
                    <i class="pi pi-user"></i>
                    <InputText id="username" type="text" class="w-full md:w-25rem" placeholder="Apellido contacto" />
                </span>
                <span class="p-input-icon-left w-full mb-4">
                    <i class="pi pi-user"></i>
                    <InputText id="username" type="text" class="w-full md:w-25rem" placeholder="Dirección empresa" />
                </span>
                <span class="p-input-icon-left w-full mb-4">
                    <i class="pi pi-envelope"></i>
                ...
                <span class="p-input-icon-left w-full mb-4">
                    <i class="pi pi-envelope"></i>
                    <InputText id="email" type="text" class="w-full md:w-25rem" placeholder="Numero de telefono" />
                </span>
               
               
                <Button label="Registrate" class="w-full mb-4"></Button>
                <span class="font-medium text-600"> Ya tienes cuenta? <a class="font-semibold cursor-pointer text-900 hover:text-primary transition-colors transition-duration-300" @click="navigateToLogin">Login</a> </span>
            </div>
        </div>
    </div>
    <AppConfig simple />
